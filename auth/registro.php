...
if (!isset($conexion) || $conexion->connect_error) {
    ...
    //Ejecuammos la consulta para traer los departamentos ordenados
...
<body class="login-page">
    ...
    <div class="login-wrapper" style="max-width: 460px; padding-top: 40px; padding-bottom: 40px;"> 
        ...
        <div class="login-card">
            ...
            <div class="login-card-body">
                ...
                <?php if (isset($_GET['error'])): ?> //Manejo de errores
                ...
                <form id="form-registro" action="validar_registros.php" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <?php  //if ve si hay al menos un registro, el while trae todos los departamentos y los asocia en una variable local y despues los traigo con specialchar
                            ...
                            } else { // si no  hay niuno pues uso esa como respaldo
    ...
    <small id="password-feedback" class="text-muted">Mínimo 12 caracteres, mayúsculas, números y símbolos.</small>
</div>
...
<script>
    // Navegación con tecla enter de los campos
    const fields = ['nombres', 'apellidos', 'correo', 'usuario_login', 'telefono', 'password', 'confirm_password'];
